...
<br></br>
      ...
      <br></br>
<p className="mt5">
      <h2 className="mt-4">Add Student's Admission</h2>
      </p>
      <div className="row">
      ...
      <button style={{width:"150px",backgroundColor:"lightgreen"}}className="btn btn-success" onClick={handleAddStudent}>Add Student</button>
      <Link to  ="/adminservice"><button style={{width:"150px",backgroundColor:"lightblue"}} className="btn btn-success" onClick={handleAddStudent}>Add courses ---&gt; </button></Link>
