...
function Login() {
  ...
  return (
    ...
    <div className='Login'> 
      ...
      <div className="main"  style ={{backgroundColor: "white",height:"540px"}} >
        ...
        <div className="signup">
          <form onSubmit={handleSubmit} >
            ...
            <input style ={{width : "250px",height : "50%"}} 
              ...
              required=""
            />
            <Link to ="/home"><button style={{ color: "black" }}>Sign up</button></Link>
        ...
        <div className="login">
          <form onSubmit={handleSubmit}>
            ...
            <input style ={{width : "250px",height : "50%"}}     
              ...
              required=""
            />
            <Link to="/home"><button style={{ color: "black" }}>Login</button></Link>
            {errorMessage && <p style={{ textAlign: "center", color: "red" }}>{errorMessage}</p>}
          </form>
        </div>
      </div>
